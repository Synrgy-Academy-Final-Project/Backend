...
public interface ReportService {
    ...
    byte[] exportETicket2(String uname, UUID orderId, String reportFormat) throws UserNotFoundException, JRException, IOException;
    ...
    byte[] generateReportUser2(List<ReportETicketDTO> report, String reportFormat) throws IOException, JRException;
}
