...
public class Config {
    ...
    public static String CANNOT_FIND_PRODUCT = "cannot find related product";
    public static String CANNOT_FIND_ORDER = "cannot find related order";
    public static String CANNOT_FIND_MERCHANT = "cannot find related merchant";
}
